...
const STYLES: { id: Style; label: string; img: string; result: string }[] = [
  { id: 'night',         label: 'Night',         img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(56).jpeg',                        result: '/resultats/night-style.webp'    },
  { id: 'urban',         label: 'Urban',         img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(3).jpeg',                         result: '/resultats/urban-style.webp'    },
  { id: 'sport',         label: 'Sport',         img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(54).jpeg',                        result: '/resultats/fitness-style.webp'  },
  { id: 'travel',        label: 'Travel',        img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(78).jpeg',                        result: '/resultats/travel-style.webp'   },
  { id: 'food',          label: 'Food',          img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/Insta_%20wolfalexanderl%20(1).jpeg',   result: '/resultats/food-style.webp'     },
  { id: 'business',      label: 'Business',      img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(17).jpeg',                        result: '/resultats/hold-money.webp'     },
  { id: 'beach',         label: 'Beach',         img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(28).jpeg',                        result: '/resultats/summer-style.webp'   },
  { id: 'tennis',        label: 'Tennis',        img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(33).jpeg',                        result: '/resultats/tennis-style.webp'   },
  { id: 'foot',          label: 'Foot',          img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(41).jpeg',                        result: '/resultats/foot-style.webp'     },
  { id: 'basket',        label: 'Basket',        img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/Kansas%20High%20School%20Basketball.jpeg', result: '/resultats/basket-style.webp' },
  { id: 'lifestyle-boy', label: 'Lifestyle Boy', img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/cusbclo.jpeg',                         result: '/resultats/boy-lifestyle.webp'  },
  { id: 'lifestyle-man', label: 'Lifestyle Man', img: 'https://pnmajvnkvyjlkbscwsto.supabase.co/storage/v1/object/public/style-previews/_%20(18).jpeg',                        result: '/resultats/man-lifestyle.webp'  },
]
