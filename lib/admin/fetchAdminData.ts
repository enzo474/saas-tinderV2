...
export async function fetchAdminData() {
  ...
  const topTones = Object.entries(toneCounts).sort((a, b) => b[1] - a[1]).slice(0, 6)
  ...
  function abFunnel(rows: RizzRow[]) {
    ...
    const topTonesList = Object.entries(toneDist).sort((a, b) => b[1] - a[1])
    ...
    return {
      ...
      withImage, oui, non, mobile, desktop, topTones: topTonesList, girlDist, avgDuration,
