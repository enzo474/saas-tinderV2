...
const PLACEHOLDER_STORY = 'https://placehold.co/400x600/1A1A1A/666666?text=Story+ici'
  ...
  if (step === 'loading' && answer) {
    return (
      <RizzLoadingStep
        userMessage={message}
        userAnswer={answer}
        screenshotUrl={PLACEHOLDER_STORY}
        flowType="test-1"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div
          ...
          style={{ borderColor: '#2A2A2A', aspectRatio: '9/16', maxHeight: '340px' }}
        >
          <img
            src={PLACEHOLDER_STORY}
            alt="Story"
